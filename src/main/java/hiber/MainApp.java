...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      String model = "vaz";
      int series = 2102;
      List<User> users2 = userService.findUser(model, series);
            for (User user : users2) {
         System.out.println("Авто, модель - " + model + "; серии - " + series +
                 "; принадлежит - " + user.getFirstName());
      }
